...
const Terbaik = () => {
  ...
  return (
    <div className="items-center bg-basic pb-16 pt-2 xl:pt-10 px-8 xl:px-24">
      <div className="">
        <div
        ...
        >
          <div className="font-black pointer-events-none">
            <div className="mt-1 justify-center sm:gap-1.5 md:gap-1 xl:gap-1 mobile:gap-1.5">
              <div className="text-[#547758] font-Satisfy text-2xl xl:text-4xl font-bold mb-1 text-center">
                Terbaik dari Pandean
              </div>
            </div>
          </div>
          <div className="text-[#547758] sm:text-base xl:text-xl text-center mb-10">
